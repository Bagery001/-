...
void Initial()
{
	glClearColor(0.0f, 1.0f, 1.0f, 1.0f);//设置窗口背景颜色（清空当前颜色缓冲）
	glLineWidth(18.0f);                 //设置线的宽度
...
int main(void)
{
	...
	glutInitDisplayMode(GLUT_SINGLE | GLUT_RGB); //使用双缓存及RGB模型
	glutInitWindowPosition(000, 300);
	glutInitWindowSize(300, 400);
	glutCreateWindow("反走样处理后图形");
