...
void winReshapeFen (int newWidth, int newHeight){
...
struct point
{
    float x;
    float y;
}polypoint[POINTNUM]= { {250,70},{550,150},{550,300},{250,250},{100,350},{100,100},{120,80} }; //多边形顶点
...
void init(int argc,char** argv)
{
    ...
    glutInitWindowPosition(70,100);  //设置窗口的顶部和左边位置
    glutInitWindowSize(400,500);  //设置窗口的高度和宽度
